...
export const mockHolidayResults = [
...

  {
    ...
    hotelSummary: 'Flight-only mock. No Duffel order, payment or booking confirmation has been created.',
    nights: 4,
    departureAirport: 'London (All Airports)',
    returnAirport: 'Barcelona',
    dateLabel: 'Flexible city break dates',
    ...
    baggageLabel: 'Demo only: baggage and fare rules must be confirmed before booking.',
    protectionLabel: 'Mock search result only; no booking or payment is created.',
    bookingMode: 'enquiry',
    partnerUrl: '',
