...
export const mockHolidayResults = [
  ...
  {
    id: 'mock-duffel-barcelona-flight',
    resultType: 'flight-only',
    provider: 'duffel',
    supplierName: 'Duffel-shaped mock flight result',
    airlineNames: ['Vueling', 'British Airways'],
    destination: 'Barcelona',
    country: 'Spain',
    ...
    priceFrom: 96,
    currency: 'GBP',
    priceQualifier: 'demo flight-only search result; no booking created',
    priceType: 'flight-only demo total',
    ...
    savingLabel: 'MOCK DUFFEL',
    rating: 'Demo result',
    flightSummary: 'London to Barcelona return flight mock shaped like a Duffel offer',
    hotelSummary: 'Flight-only mock. No payment taken and no supplier action created by PickyHoliday.',
    nights: 4,
    departureAirport: 'London (All Airports)',
    returnAirport: 'Barcelona',
    dateLabel: 'Flexible city break dates',
    groupSizeLabel: '2 adults',
    boardBasis: 'Flight only; economy cabin demo',
    baggageLabel: 'Demo only: baggage and fare rules must be confirmed before any next step.',
    protectionLabel: 'Mock search result only. No booking created. No payment taken by PickyHoliday.',
    bookingMode: 'enquiry',
    partnerUrl: '',
    tags: ['Holidays', 'Flights', 'Duffel', 'Barcelona', 'City breaks'],
    isDemo: true,
  },
  {
    id: 'mock-duffel-ibiza-flight',
    resultType: 'flight-only',
    provider: 'duffel',
    supplierName: 'Duffel-shaped mock flight result',
    airlineNames: ['easyJet', 'Ryanair'],
    ...
    savingLabel: 'MOCK DUFFEL',
    rating: 'Demo result',
    flightSummary: 'Manchester to Ibiza return flight mock shaped like a Duffel offer',
    hotelSummary: 'Flight-only mock. No payment taken and no supplier action created by PickyHoliday.',
    nights: 7,
    departureAirport: 'Manchester',
    returnAirport: 'Ibiza',
    ...
    bookingMode: 'enquiry',
    partnerUrl: '',
    tags: ['Holidays', 'Flights', 'Duffel', 'Ibiza', 'Party holidays'],
    isDemo: true,
  },
  {
