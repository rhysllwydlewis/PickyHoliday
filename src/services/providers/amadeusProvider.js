...
export function createAmadeusProvider(config = {}) {
  ...
  const mapFlightOffer = (offer, criteria = {}, dictionaries = {}, resolvedRequest = null) => {
    ...
    return {
      ...
      baggageLabel: 'Baggage and fare-rule caveats must be checked with the airline/supplier before any next step.',
      protectionLabel: 'Search only. No booking created. No payment taken by PickyHoliday.',
      bookingMode: 'enquiry',
      partnerUrl: '',
