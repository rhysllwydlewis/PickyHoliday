...
const partnerCard = (partner, criteria = {}, index = 0, trackingId = '') => {
  ...
  return {
    ...
    hotelSummary: 'PickyHoliday links to a partner search page; the partner confirms live price, availability and terms on their site.',
    nights,
    ...
    baggageLabel: 'Baggage and transfers are shown by the partner before any next step.',
    protectionLabel: 'Partner terms confirmed on partner site. No payment taken by PickyHoliday.',
